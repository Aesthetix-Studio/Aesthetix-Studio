...
const screen=(eyebrow,title,sub,cards=[],img=true)=>`<main><section class="screen-head section"><div class="eyebrow">${eyebrow}</div><h1>${title}</h1><p class="small">${sub}</p>${img?`<div class="screen-img"><img src="${PH}" alt=""></div>`:''}</section>${cards.length?`<section class="screen-cards section"><div class="screen-grid">${cards.map(c=>`<div class="scard"><div class="eyebrow">${c[0]}</div><h3>${c[1]}</h3><p class="small">${c[2]}</p></div>`).join('')}</div></section>`:''}</main>`;
...
const pages={"index.html":['Aesthetix Studio — Digital Product Studio','Digital products that create measurable business impact.','',home],"work.html":['Luminary Financial — Aesthetix Studio','A modern wealth management platform built for clarity and trust.','work',work],"capabilities.html":['Capabilities — Aesthetix Studio','What we do and how we help.','capabilities',capabilities],"journal.html":['Journal — Aesthetix Studio','Thinking about the work.','journal',journal],"studio.html":['Studio — Aesthetix Studio','We design and build digital products with purpose.','studio',studio],"contact.html":['Contact — Aesthetix Studio','Let’s create something inspiring together.','contact',contact],"start-a-project.html":['Start a Project — Aesthetix Studio','Tell us about your project.','contact',generic('Start a project')],"case-studies.html":['Case Studies — Aesthetix Studio','The work, in depth.','work',caseStudies],"careers.html":['Careers — Aesthetix Studio','Join the studio.','studio',generic('Come build with us')],"process.html":['Process — Aesthetix Studio','A thoughtful process designed for impact.','capabilities',generic('A thoughtful process')],"404.html":['Page not found — Aesthetix Studio','The page could not be found.','',generic('Page not found')]};
Object.assign(pages,{
"500.html":['Server Error — Aesthetix Studio','Something went wrong on our end.','',screen('Server error','Something went wrong on our end.','We’ve logged the issue and will have it fixed shortly. Please try again in a few minutes.',[],false)],
...
"forgot-password.html":['Forgot password — Aesthetix Studio','Reset your password.','',authScreen('Account','Reset your password','Enter your email and we’ll send you a reset link.',[['email','you@company.com','Email']],'Send reset link','Remembered it? <a href="/login.html">Sign in</a>')],
"reset-password.html":['Reset password — Aesthetix Studio','Choose a new password.','',authScreen('Account','Choose a new password','Pick a strong password for your account.',[['password','••••••••','New password'],['password','••••••••','Confirm password']],'Reset password','<a href="/login.html">Back to sign in</a>')],
"verify-email.html":['Verify email — Aesthetix Studio','Confirm your email address.','',authScreen('Account','Check your inbox','We’ve sent a verification link to your email address.',[],'Verify email','Didn\'t get it? <a href="#">Resend link</a>')],
...
"projects.html":['Projects — Aesthetix Studio','Every engagement, organized.','',screen('Projects','Every engagement, organized.','Track progress, timelines, and deliverables per project.',[['Active','12','In progress now.'],['In review','3','Awaiting client feedback.'],['Completed','48','Shipped and documented.']])],
...
"invoices.html":['Invoices — Aesthetix Studio','Bill and get paid.','',screen('Invoices','Bill and get paid.','Send invoices and track payment status.',[['Outstanding','$18,400','Due this month.'],['Paid','$65,800','Collected year to date.'],['Drafts','3','Not yet sent.']])],
"users.html":['Users — Aesthetix Studio','Team and client access.','',screen('Users','Team and client access.','Manage roles, invites, and permissions.',[['Team','9','Across design and engineering.'],['Clients','24','Portal access granted.'],['Pending','2','Invites not accepted.']])],
"settings.html":['Settings — Aesthetix Studio','Your workspace configuration.','',screen('Settings','Your workspace configuration.','Profile, billing, and preferences in one place.',[['Profile','Name, email, avatar','Keep your details current.'],['Billing','Plan and invoices','Manage your subscription.'],['Preferences','Notifications','Choose what you hear about.']])],
"analytics.html":['Analytics — Aesthetix Studio','Traffic and behavior.','',screen('Analytics','Traffic and behavior.','Visitors, sources, and conversions across the site.',[['Visitors','48K','Last 30 days.'],['Conversion','4.2%','Form completions.'],['Top source','Organic','38% of sessions.']])],
"search.html":['Search — Aesthetix Studio','Find anything fast.','',screen('Search','Find anything fast.','Search projects, leads, files, and notes.',[['Files','1,240','Indexed documents.'],['People','33','Team and clients.'],['Projects','48','Full history.']])],
"forms.html":['Forms — Aesthetix Studio','Every submission in one place.','',screen('Forms','Every submission in one place.','Capture and review form data from all pages.',[['Contact form','214','Submissions this quarter.'],['Start a project','61','Qualified inquiries.'],['Newsletter','1,024','New subscribers.']])],
"articles.html":['Articles — Aesthetix Studio','Journal content management.','',screen('Articles','Journal content management.','Draft, edit, and publish posts.',[['Published','24','Live on the site.'],['Drafts','6','In progress.'],['Scheduled','3','Queued to publish.']])],
"feedback.html":['Feedback — Aesthetix Studio','Collect and review input.','',screen('Feedback','Collect and review input.','Surveys, ratings, and client comments.',[['Surveys','4','Active this quarter.'],['Responses','318','Collected so far.'],['Net promoter','62','Client score.']])],
"maintenance.html":['Maintenance — Aesthetix Studio','Scheduled updates.','',screen('Maintenance','Scheduled updates.','Track maintenance windows and uptime.',[['Uptime','99.9%','Last 90 days.'],['Windows','2','Planned this month.'],['Incidents','0','Open right now.']])],
"knowledge-base.html":['Knowledge Base — Aesthetix Studio','Self-serve answers.','',screen('Knowledge base','Self-serve answers.','Articles and guides for clients and the team.',[['Articles','86','Published guides.'],['Views','12K','This month.'],['Helpful','92%','Readers found answers.']])],
"meeting-notes.html":['Meeting Notes — Aesthetix Studio','Notes from every call.','',screen('Meeting notes','Notes from every call.','Summaries, action items, and follow-ups.',[['This week','9','Calls logged.'],['Action items','27','Open tasks.'],['Recurring','3','Weekly syncs.']])],
"project-timeline.html":['Project Timeline — Aesthetix Studio','Every phase on schedule.','',screen('Project timeline','Every phase on schedule.','Milestones across the full project lifecycle.',[['Discover','Complete','Week 1-2.'],['Design','In progress','Week 3-5.'],['Deliver','Scheduled','Week 6-8.']])],
"proposal.html":['Proposal — Aesthetix Studio','The offer, ready to send.','',screen('Proposal','The offer, ready to send.','Scope, timeline, and investment for the client.',[['Scope','12 weeks','Strategy, design, build.'],['Investment','$48,000','Fixed fee.'],['Status','Draft','Not yet sent.']])],
"proposal-request.html":['Proposal Request — Aesthetix Studio','A new request came in.','',screen('Proposal request','A new request came in.','Review the brief and prepare your response.',[['Client','Meridian','Fintech platform.'],['Budget','$40-60K','Indicated range.'],['Deadline','2 weeks','Response due.']])],
"proposal-generator.html":['Proposal Generator — Aesthetix Studio','Build proposals fast.','',screen('Proposal generator','Build proposals fast.','Assemble scope, pricing, and terms into a polished document.',[['Templates','12','Reusable structures.'],['Generated','34','Proposals this year.'],['Win rate','58%','Accepted proposals.']])],
"files-deliverables.html":['Files & Deliverables — Aesthetix Studio','Everything shipped.','',screen('Files and deliverables','Everything shipped.','Assets, documents, and exports per project.',[['Assets','860','Design files and images.'],['Docs','142','Guides and specs.'],['Exports','96','Packaged for clients.']])],
"audit-analysis.html":['Audit & Analysis — Aesthetix Studio','Deep-dive reports.','',screen('Audit and analysis','Deep-dive reports.','Performance, UX, and SEO findings in one report.',[['Pages audited','46','Full site coverage.'],['Issues','128','Prioritized list.'],['Score','74/100','Current baseline.']])],
"accessibility.html":['Accessibility — Aesthetix Studio','Design for everyone.','',screen('Accessibility','Design for everyone.','WCAG-aligned checks across the experience.',[['WCAG AA','94%','Conformance across pages.'],['Contrast','Pass','Text and UI elements.'],['Keyboard','100%','Fully navigable.']])],
"accessibility-scanner.html":['Accessibility Scanner — Aesthetix Studio','Automated audits.','',screen('Accessibility scanner','Automated audits.','Scan pages for accessibility issues and fixes.',[['Scans','18','This month.'],['Issues','37','Found and triaged.'],['Fixed','29','Resolved already.']])],
"ai-chat-assistant.html":['AI Chat Assistant — Aesthetix Studio','Answers, instantly.','',screen('AI chat assistant','Answers, instantly.','A trained assistant for your content and questions.',[['Conversations','412','This month.'],['Resolved','87%','Answered without handoff.'],['Sources','24','Connected documents.']])],
"ai-solutions.html":['AI Solutions — Aesthetix Studio','Intelligence, built in.','',screen('AI solutions','Intelligence, built in.','Automations and insights embedded in your product.',[['Workflows','6','Live automations.'],['Automated','1.2K','Tasks handled.'],['Time saved','38h','Per month.']])],
...
"performance-analyzer.html":['Performance Analyzer — Aesthetix Studio','Speed, quantified.','',screen('Performance analyzer','Speed, quantified.','Core Web Vitals and load performance per page.',[['LCP','1.8s','Good.'],['CLS','0.02','Good.'],['INP','120ms','Good.']])],
"seo-analyzer.html":['SEO Analyzer — Aesthetix Studio','Rankings and health.','',screen('SEO analyzer','Rankings and health.','On-page SEO, backlinks, and keyword positions.',[['Keywords','240','Tracked.'],['Avg. position','7.4','Search.'],['Organic','68K','Sessions per month.']])],
"seo-service.html":['SEO Service — Aesthetix Studio','Grow organic traffic.','',screen('SEO service','Grow organic traffic.','Technical SEO, content, and authority building.',[['Traffic','+42%','Year over year.'],['Rankings','38','Page one terms.'],['Audits','Quarterly','Full reports.']])],
"website-audit-tool.html":['Website Audit Tool — Aesthetix Studio','A full health check.','',screen('Website audit tool','A full health check.','Technical, UX, and content issues across the site.',[['Pages','46','Checked.'],['Errors','23','Actionable.'],['Health','81/100','Overall.']])],
"website-redesign.html":['Website Redesign — Aesthetix Studio','A fresh start.','',screen('Website redesign','A fresh start.','Reimagine the site around your business goals.',[['Timeline','10 weeks','Discovery to launch.'],['Pages','28','Designed and built.'],['Conversion','+35%','After launch.']])],
...
"rss-feed.html":['RSS Feed — Aesthetix Studio','Syndicate your content.','',screen('RSS feed','Syndicate your content.','Deliver journal posts to subscribers and readers.',[['Subscribers','2,400','Feed readers.'],['Posts','24','Published.'],['Clicks','18K','Monthly.']])],
"sitemap-tool.html":['Sitemap — Aesthetix Studio','Every page, mapped.','',screen('Sitemap','Every page, mapped.','Structure and hierarchy of the whole site.',[['Pages','46','Indexed.'],['Depth','3','Max levels.'],['Updated','Auto','On publish.']])],
"media-library.html":['Media Library — Aesthetix Studio','One place for images.','',screen('Media library','One place for images.','Upload, organize, and reuse media across pages.',[['Images','1,240','In the library.'],['Used','860','On live pages.'],['Unused','380','Available.']])]
});
...
Object.assign(pages,{
"work/luminary-financial.html":['Luminary Financial — Aesthetix Studio','A modern wealth management platform built for clarity and trust.','work',caseStudy(dLum)],
"work/kora-health.html":['Kora Health — Aesthetix Studio','A patient-first platform for complex healthcare journeys.','work',caseStudy(dKora)],
"work/vertex.html":['Vertex — Aesthetix Studio','An analytics platform that turns data into decisions.','work',caseStudy(dVertex)]
});
for(const [file,[title,description,key,body]] of Object.entries(pages))write(file,page(title,description,key,body,file==='index.html'?'/':'/'+file.replace(/\.html$/,'')));
/* sitemap: clean canonical URLs (no .html), error pages excluded */
const SITE='https://aesthetixstudio.com';
const clean=Object.keys(pages).filter(f=>f.endsWith('.html')&&f!=='404.html'&&f!=='500.html').map(f=>f==='index.html'?'':f.replace(/\.html$/,'')).sort();
...
for(const f of fs.readdirSync(protoDir))write(f,read(path.join('site','proto',f)));
