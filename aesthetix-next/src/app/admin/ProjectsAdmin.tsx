    ...
    return (
      <div>
        <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 32 }}>
          ...
          }}>{editing.id ? "Edit" : "New"} Project</h1>
        </div>

        <div style={{
          background: "rgba(255,255,255,0.025)", border: "1px solid rgba(255,255,255,0.07)",
          padding: "32px", maxWidth: 640, position: "relative", overflow: "hidden",
        }}>
  ...
  return (
    <div>
      <ConfirmDialog
        ...
        message={`This will permanently delete "${deleteTarget?.title}" and cannot be undone.`}
      ...
      {projects.length === 0 && (
        <p style={{ color: "rgba(240,235,224,0.25)", fontFamily: "'Inter', sans-serif", fontSize: "13px" }}>No projects yet.</p>
      )}
      ...
      <div style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.07)" }}>
        <div style={{
          ...
          {["Project", "Category", "Slug", "Year", ""].map(col => (
        ...
        {projects.map((p, i) => (
          <div key={p.id} style={{
            display: "grid", gridTemplateColumns: "2fr 1fr 1fr 80px 120px",
            padding: "16px 24px", borderBottom: i < projects.length - 1 ? "1px solid rgba(255,255,255,0.04)" : "none",
          ...
          >
            <div>
              <div style={{ fontSize: "13px", fontFamily: "'Instrument Serif', serif", fontStyle: "italic", color: "rgba(240,235,224,0.85)", marginBottom: "2px" }}>
                {p.title}
                {p.is_featured ? <span style={{ fontSize: "9px", color: "#C4A46B", marginLeft: "6px", fontFamily: "'Inter', sans-serif", fontStyle: "normal" }}>★</span> : null}
              </div>
            </div>
