    ...
    >
      <div
        ...
        style={{
          ...
          width: "60vw",
          height: "60vw",
          background: "radial-gradient(ellipse, rgba(196,164,107,0.06) 0%, transparent 65%)",
          filter: "blur(100px)",
        }}
      />
      <div
        ...
        style={{
          ...
          width: "50vw",
          height: "50vw",
          background: "radial-gradient(ellipse, rgba(196,164,107,0.04) 0%, transparent 70%)",
          filter: "blur(120px)",
        }}
      />
      ...
      <div ref={ref} className="max-w-4xl relative z-10">
        ...
        >
          {!submitted ? (
            <form
              action={formAction}
              style={{ display: "flex", flexDirection: "column", maxWidth: "560px", gap: "8px" }}
            >
...
//             </div>
//             {state.error && (
//               <p style={{ color: "#f87171", fontSize: "12px", fontFamily: "'Inter', sans-serif", margin: "4px 0 0", paddingLeft: "4px" }}>
//                 {state.error}
//               </p>
//             )}
//           </form>
