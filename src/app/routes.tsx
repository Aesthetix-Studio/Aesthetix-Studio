...
export const router = createBrowserRouter([
  {
    ...
    children:[
      ...
      { path:"showcase/minimal", lazy: lazyPage(() => import("./pages/portfolio/MinimalSite")) },
      { path:"showcase/editorial", lazy: lazyPage(() => import("./pages/portfolio/EditorialSite")) },
      { path:"showcase/premium-saas", lazy: lazyPage(() => import("./pages/portfolio/PremiumSaasSite")) },
      { path:"showcase/creative-studio", lazy: lazyPage(() => import("./pages/portfolio/CreativeStudioSite")) },
      { path:"showcase/enterprise", lazy: lazyPage(() => import("./pages/portfolio/EnterpriseSite")) },
      { path:"showcase/luxury", lazy: lazyPage(() => import("./pages/portfolio/LuxurySite")) },
      { path:"showcase/startup", lazy: lazyPage(() => import("./pages/portfolio/StartupSite")) },
      { path:"showcase/modern-tech", lazy: lazyPage(() => import("./pages/portfolio/ModernTechSite")) },
      { path:"showcase/brutalist", lazy: lazyPage(() => import("./pages/portfolio/BrutalistSite")) },
      { path:"showcase/high-end-portfolio", lazy: lazyPage(() => import("./pages/portfolio/HighEndPortfolioSite")) },

      {
        ...
        children:[
          ...
          { path:"accessibility", lazy: lazyPage(() => import("./pages/Accessibility")) },
