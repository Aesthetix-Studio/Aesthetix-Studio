...
const styles: Record<string, React.CSSProperties> = {
  ...
  capCard: { background: "#111", border: "1px solid #1f1f1f", borderRadius: 6, padding: "16px 20px", display: "flex", alignItems: "center", gap: 16 },
  ...
  outcomeCard: { background: "#111", border: "1px solid #1f1f1f", borderRadius: 6, padding: "20px 24px" },
