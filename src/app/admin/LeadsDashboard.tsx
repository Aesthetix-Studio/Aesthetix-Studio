  ...
  return (
    <div>
      <div style={{ marginBottom: 32 }}>
        <h1 style={{ fontFamily: "'Instrument Serif', serif", fontSize: "24px", fontStyle: "italic", color: "#F0EBE0", letterSpacing: "-0.02em", margin: 0, marginBottom: "4px" }}>Inquiries</h1>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "1px", background: "rgba(255,255,255,0.06)", marginBottom: 32 }}>
        {[
          ...
          <div key={stat.label} style={{ background: "rgba(255,255,255,0.025)", border: "1px solid rgba(255,255,255,0.07)", padding: "24px", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.07)" }}>
        <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 120px 100px", padding: "12px 24px", borderBottom: "1px solid rgba(255,255,255,0.06)", gap: "16px" }}>
        ...
        {visible.map((lead, i) => (
          <div key={lead.id} style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 120px 100px", padding: "16px 24px", borderBottom: i < visible.length - 1 ? "1px solid rgba(255,255,255,0.04)" : "none", alignItems: "center", gap: "16px", transition: "background 0.2s ease" }}
